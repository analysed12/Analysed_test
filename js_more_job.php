...
<link rel="stylesheet" href="./css/js_more_job.css">
<body>
        ...
        <div class="row">
            <div class="col-9">
              ...
              <?php
                    ...
                    $sql3="SELECT * FROM `joblistings` WHERE (state $exclamloc='$location' )AND (package BETWEEN $minsal AND $maxsal) AND (industry $exclamindus= '$chooseindustry') AND (job_type='$jobtype') AND (skills LIKE '$skill')";
